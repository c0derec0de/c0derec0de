...
Я — Ульяна, студентка 4 курса Воронежского государственного университета Факультета компьютерных наук. Являюсь фронтенд-разработкчиком, создаю удобные интерфейсы.
...
- Интегрирую фронтенд с REST API
